    ...
    render() {
        return (
            <div className='budget-show-form-container'>
                <div className='budget-show-form-container2'>
                    <h3 className='budget-show-form-header'>{this.props.budgetHeader}</h3>
                    <div className='budget-show-category-container'>
                        ...
                        <div className='budget-show-category-head'>Savings: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.savings * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Debt: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.debt * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Home: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.home * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Transportation: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.transportation * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Personal Care: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.personalCare * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Food And Dining: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.foodAndDining * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Shopping: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.shopping * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Entertainment: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.entertainment * this.props.budget.income).toFixed(2)}</div>
                        ...
                        <div className='budget-show-category-head'>Miscellaneous: 
                            <div className='budget-show-category'>
                                <div className='budget-show-category-item'>
                                    <div>${(this.props.budget.miscellaneous * this.props.budget.income).toFixed(2)}</div>
